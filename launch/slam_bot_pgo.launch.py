...
def generate_launch_description():
    ...
    self_mapper_pgo = Node(
        package='slam_bot',
        executable='self_mapper_pgo',
        name='self_mapper_pgo',
    ...
    gz_sim = IncludeLaunchDescription(
        ...
        launch_arguments={'gz_args': '-r ' + os.path.join(get_package_share_directory('slam_bot'), 'worlds', 'ionic.sdf')}.items(),
    )
    spawn_robot = Node(
        package='ros_gz_sim',
        executable='create',
