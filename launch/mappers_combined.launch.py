...
def generate_launch_description():
    ...
    ground_truth = make_slam_and_rviz('ground_truth', 'mapper_using_ground_truth', 'slam_bot_ground_truth.rviz')
    icp = make_slam_and_rviz('icp', 'mapper_using_odom_with_icp', 'slam_bot_icp.rviz')
    pgo = make_slam_and_rviz('pgo', 'mapper_with_pgo', 'slam_bot_pgo.rviz')
