...
class Mapper_Using_GroundTruth(Node):
    def __init__(self):
        super().__init__('mapper_using_ground_truth')
        ...
        self.tf_publisher = self.create_publisher(TFMessage, "/ground_truth/tf", 10)
    ...
    def robot_tf_callback(self, msg):
        ...
        self.robot_tf_msg.transforms[1].transform.translation.x += -1.6
        self.robot_tf_msg.transforms[1].transform.translation.y += 1.2
        self.robot_tf_msg.transforms[1].transform.translation.z = 0.0       
        return
    ...
    def publish_map_to_odom_tf(self, cur_robot_tf):
        ...
        self.tf_publisher.publish(TFMessage(transforms=[map_to_odom]))       
...
def main(args = None):
    ...
    mapper_using_ground_truth = Mapper_Using_GroundTruth()
    rclpy.spin(mapper_using_ground_truth)
    mapper_using_ground_truth.destroy_node()
    rclpy.shutdown()
